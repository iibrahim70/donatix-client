...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="space-y-8 overflow-y-auto scroll-smooth scrollbar-thin scrollbar-track-rounded-full scrollbar-thumb-black/50 scrollbar-track-transparent">
          <SidebarHeader />
          <SidebarNavigation />
        </div>
